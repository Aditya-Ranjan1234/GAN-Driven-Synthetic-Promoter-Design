@echo off
REM Script to preprocess DNA sequences and check the results
...
REM Check the content of the extracted FASTA file
...
REM Check the content of the preprocessed FASTA file
echo.
