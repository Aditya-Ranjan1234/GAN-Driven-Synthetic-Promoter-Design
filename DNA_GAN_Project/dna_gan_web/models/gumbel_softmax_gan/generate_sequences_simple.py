...
def generate_sequences(num_sequences, output_file, gc_bias=0.45):
    """
...
def main():
    ...
    parser.add_argument('--gc_bias', type=float, default=0.45, help='GC bias for the sequences')
