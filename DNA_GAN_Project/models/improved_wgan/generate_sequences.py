"""
Script to generate DNA sequences from a trained model.
"""
...
from models.improved_wgan.models import ImprovedGenerator
from models.improved_wgan.data import save_sequences_to_fasta


def main():
    """
    Main function to generate DNA sequences from a trained model.
    """
    # Parse command-line arguments
    parser = argparse.ArgumentParser(description='Generate DNA sequences from a trained model')
    
    parser.add_argument('--checkpoint', type=str, default='checkpoints/improved_dna_gan/final_model.pt',
    ...
    with torch.no_grad():
        ...
        for i in range(num_batches):
            ...
            sequences = generator(noise, temperature=args.temperature, hard=True)
