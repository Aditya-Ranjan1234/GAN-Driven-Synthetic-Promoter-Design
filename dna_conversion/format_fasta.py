"""
Format FASTA file for proper loading

This script reads the original FASTA file and creates a properly formatted
version that can be loaded by bioinformatics tools.
"""
    ...
    with open(output_file, 'w', encoding='utf-8') as f:
        for entry in entries:
            ...
            if id_match:
                ...
                # If no EP ID found, use the whole header
                # Skip empty headers
                if not header:
                    continue
                f.write(f">{header}\n")
