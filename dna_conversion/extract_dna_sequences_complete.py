"""
Extract DNA sequences from HTML file and convert to CSV and FASTA

This script extracts DNA sequences from an HTML file containing FASTA data,
cleans up the data, and converts it to both CSV and FASTA formats.
"""
...
def main():
    ...
    fasta_file = 'data/dna_sequences.fasta'
    ...
    with open(fasta_file, 'w') as f:
        for record in records:
            f.write(f">{record['sequence_id']} {record['description']}\n")
    ...
    print(f"Also saved sequences in FASTA format to {fasta_file}")
