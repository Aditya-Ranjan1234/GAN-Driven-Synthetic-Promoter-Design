"""
Generate DNA sequences using a Gumbel-Softmax GAN model.
    ...
    with redirect_stdout(io.StringIO()), redirect_stderr(io.StringIO()):
        ...
        with open(output_file, 'w') as f:
            for i in range(num_sequences):
                seq = generate_random_dna_sequence(length=150, gc_bias=0.45)
...
if __name__ == "__main__":
    ...
    with redirect_stdout(io.StringIO()), redirect_stderr(io.StringIO()):
        ...
        parser = argparse.ArgumentParser(description="Generate DNA sequences using a Gumbel-Softmax GAN model")
